			...
			<div class="p-5">
				<h2>
					<span class="text-light">
						<b><?php echo $data_hotel[0]->nama_hotel ?></b>
					</span>
				</h2>
				<p>
					<span class="text-light">
						<span class="fa fa-map-marker fa-fw"></span><?php echo $data_hotel[0]->alamat ?>
					</span>
				</p>
			</div>
		</div>
				...
				<div class="bg-secondary">
					<div id="SlidePhoto" class="carousel slide carousel-fade" data-ride="carousel">
						<ol class="carousel-indicators m-0">
							<?php foreach ($hotel_foto as $key => $value) : ?>
								<li data-target="#SlidePhoto" data-slide-to="<?php echo $key ?>" class="active"><img src="<?= base_url("assets/images/foto_hotel/" . $value->foto) ?>"></li>
							<?php endforeach; ?>
						</ol>
					...
					<div class="card-body">
						<div class="row m-0">
							<div class="col-sm-4 text-center">
								...
								Avalable Room(s)<br />
								<h5>
									<b><?php echo $data_hotel[0]->jml_kamar ?></b>
								</h5>
							</div>
							<div class="col-sm-4 text-center" style="border-right: 1px solid lightgray; border-left: 1px solid lightgray; ">
								...
								Minimum Stayed<br />
								<h5>
									<b><?php echo $data_hotel[0]->minimum_stay ?></b>
								</h5>
							</div>
							<div class="col-sm-4 text-center">
								<div class="m-1">
								...
								Phone<br />
								<h5>
									<b><?php echo $data_hotel[0]->notelp ?></b>
								</h5>
							</div>
						</div>
					</div>
						...
						<div class="row m-0">
							...
							<div class="col-md-6 text-right">
								<div class="btn-group btn-group-toggle" data-toggle="buttons">
									<?php foreach ($hotel_room as $key => $value) : ?>
										<label class="btn btn-light">
											<input type="radio" name="options" id="option1" autocomplete="off" checked href="<?php echo "#kamar".$key?>" data-toggle="tab"> <?php echo $value->tipe_kamar ?>
										</label>
									<?php endforeach ?>
								</div>
							</div>
										...
										<div class="col-2 text-center m-1">
											<h4>
												<span class="fa-stack fa-md" data-toggle="tooltip" data-placement="bottom" title="Tooltip on bottom">
													...
													<i class="<?php echo 'fa '.$value->icon.' fa-stack-1x text-light'?>"></i>
												</span>
											</h4>
											<small>
												<span style="line-height: 1.2rem">
													<?php echo $value->nama_fasilitas?>
												</span>
											</small>
										</div>
									<?php endforeach ?>
